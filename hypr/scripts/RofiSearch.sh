...
# Open rofi with a dmenu and pass the selected item to xdg-open for searchi
echo "" | rofi -dmenu -config "$rofi_config" -p "Search:" | xargs -I{} xdg-open "https://www.startpage.com/sp/search?query={}"
